          ...
          >
            {infoList.map(({ icon, iconDark, title, description }, index) => (
              <motion.li
                ...
                className="border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-motion.lightHover hover:-translate-y-1 duration-500 hover:shadow-black dark:border-white dark:hover:shadow-white dark:hover:bg-darkHover/50"
                key={index}
              >
                <Image
